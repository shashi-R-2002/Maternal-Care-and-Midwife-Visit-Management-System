...
<nav class="sidebar-nav">
    ...
    <a href="{{ route('midwife.dashboard') }}" class="active">
        <span class="nav-icon">
...
<div class="main">
    ...
    <!-- Topbar -->
   @include('partials.midwife-topbar')
    <!-- Content -->
    <div class="content">
        ...
        <div class="summary-grid">
            ...
            <div class="stat-card blue">
                ...
                <div class="stat-body">
                    ...
                    <div class="stat-num">{{ $totalMothers }}</div>
            ...
            <div class="stat-card amber">
                ...
                <div class="stat-body">
                   <div class="stat-label">Upcoming Visits</div>
                     <div class="stat-num">{{ $upcomingVisits }}</div>
            ...
            <div class="stat-card rose">
                ...
                <div class="stat-body">
                    ...
                    <div class="stat-num">{{ $deliveredMothers }}</div>
    ...
    <td>
        <div class="mother-cell">
            ...
            <div class="mother-avatar">
                {{ strtoupper(substr($visit->mother->full_name,0,2)) }}
            </div>

            <span class="mother-name">
                {{ $visit->mother->full_name }}
            </span>
...
@endforelse
    ...
    @elseif($mother->status == 'Delivered')
        ...
        <div class="panel" style="margin-bottom:0;">
            ...
            <div class="panel-body">
                <div class="quick-links-grid">
                    ...
                    <a href="{{ route('mothers.create') }}" class="ql-card">
                    ...
                    <a href="{{ route('midwife.visits') }}" class="ql-card">
                    ...
                    <a href="{{ route('mothers.index') }}" class="ql-card">
                    ...
                    <a href="{{ route('midwife.medicines') }}" class="ql-card">
                    ...
                    <a href="{{ route('midwife.health-record') }}" class="ql-card">
                          <div class="ql-icon">
                        <i class="bi bi-heart-pulse"></i>
                    </div>
