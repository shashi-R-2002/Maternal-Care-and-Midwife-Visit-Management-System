...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('mothers.create') }}" class="active">
...
<div class="main">
    ...
    <div class="topbar">
        <div class="topbar-left">
           <h5>Edit Mother</h5>
                <p>Update mother's information</p>
        </div>
        ...
        <div class="col-12">
            <div class="field-wrap">
                ...
                <textarea
                    ...
                    name="address"
                    rows="2"
                    placeholder="e.g. No. 12, Galle Road, Colombo 03">{{ old('address', $mother->address) }}</textarea>
        ...
        <div class="col-md-6">
            <div class="field-wrap">
                ...
                <input
                    ...
                    class="field-input"
                    name="gravida"
                    value="{{ old('gravida', $mother->gravida) }}"
                    placeholder="e.g. 2"
                    min="1">
    ...
    <div class="row g-3">
        ...
        <div class="col-md-6">
            <div class="field-wrap">
                ...
                <select class="field-input" name="blood_group">

    <option value="">Select Blood Group</option>

    <option value="A+" {{ old('blood_group', $mother->blood_group) == 'A+' ? 'selected' : '' }}>A+</option>
    <option value="A-" {{ old('blood_group', $mother->blood_group) == 'A-' ? 'selected' : '' }}>A-</option>
    <option value="B+" {{ old('blood_group', $mother->blood_group) == 'B+' ? 'selected' : '' }}>B+</option>
    <option value="B-" {{ old('blood_group', $mother->blood_group) == 'B-' ? 'selected' : '' }}>B-</option>
    <option value="AB+" {{ old('blood_group', $mother->blood_group) == 'AB+' ? 'selected' : '' }}>AB+</option>
    <option value="AB-" {{ old('blood_group', $mother->blood_group) == 'AB-' ? 'selected' : '' }}>AB-</option>
    <option value="O+" {{ old('blood_group', $mother->blood_group) == 'O+' ? 'selected' : '' }}>O+</option>
    <option value="O-" {{ old('blood_group', $mother->blood_group) == 'O-' ? 'selected' : '' }}>O-</option>
...
<div class="form-footer">
    ...
    <div class="footer-actions">
        ...
        <a href="{{ route('mothers.index') }}" class="btn-cancel">
