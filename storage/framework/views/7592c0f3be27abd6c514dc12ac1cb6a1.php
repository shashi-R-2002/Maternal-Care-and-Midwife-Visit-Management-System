...
<?php $__env->startSection('title','Health-record'); ?>
  ...
  <nav class="sidebar-nav">
   <div class="nav-section-label">Main Menu</div>
        ...
        <a href="<?php echo e(route('midwife.medicines')); ?>">
         ...
         <a href="<?php echo e(route('midwife.health-record')); ?>" class="active">
...
<div class="box mb-4">
    ...
    <div class="box-body">
        ...
        <form method="GET" action="<?php echo e(route('midwife.health-record')); ?>">
                ...
                <div class="col-md-10">
                    ...
                    <select
                        ...
                        <?php $__currentLoopData = $mothers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mother): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <option
                                value="<?php echo e($mother->id); ?>"
                                <?php echo e(request('mother_id') == $mother->id ? 'selected' : ''); ?>>

                                <?php echo e($mother->registration_no); ?>

                                -
                                <?php echo e($mother->full_name); ?>
    ...
    <div class="box-body">
        ...
        <div class="info-grid">
            ...
            <div class="info-box">
                ...
                <div class="ib-value"><?php echo e($selectedMother->registration_no); ?></div>
            </div>

            <div class="info-box">
                <div class="ib-label">Mother Name</div>
                <div class="ib-value"><?php echo e($selectedMother->full_name); ?></div>
            </div>

            <div class="info-box">
                <div class="ib-label">NIC</div>
                <div class="ib-value"><?php echo e($selectedMother->nic); ?></div>
            </div>

            <div class="info-box">
                <div class="ib-label">Phone</div>
                <div class="ib-value"><?php echo e($selectedMother->phone); ?></div>
            </div>

            <div class="info-box">
                <div class="ib-label">Address</div>
                <div class="ib-value"><?php echo e($selectedMother->address); ?></div>
            </div>

            <div class="info-box">
                <div class="ib-label">Status</div>
                <div class="ib-value"><?php echo e($selectedMother->status); ?></div>
            </div>
...
<?php endif; ?>
    ...
    <div class="tab-panel active" id="tab-antenatal">
      ...
      <div class="box">
        ...
        <div class="box-body">
          <form method="POST" action="<?php echo e(route('health-record.store')); ?>">
    <?php echo csrf_field(); ?>

    <input type="hidden" name="mother_id" value="<?php echo e($selectedMother->id ?? ''); ?>">
...
<tr>
    <td>
        ...
        <?php echo e(optional($record->visit)->visit_date); ?>
    ...
    <td><?php echo e($record->weight); ?> kg</td>

    <td>
        <span class="bp-cell bp-normal">
            <?php echo e($record->blood_pressure); ?>

        </span>
    </td>

    <td><?php echo e($record->blood_sugar); ?></td>

    <td><?php echo e($record->hemoglobin); ?></td>

    <td><?php echo e($record->urine_sugar); ?></td>

    <td><?php echo e($record->urine_protein); ?></td>
    ...
    <td>
        <div class="action-btns">
            ...
            <form action="<?php echo e(route('health-record.destroy', $record->id)); ?>"
                  method="POST"
...
—
<?php echo e($selectedMother->full_name ?? 'No Mother Selected'); ?></span>
...
<?php echo $__env->make('layouts.midwife', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\maternal-care-system\resources\views/midwife/health-record.blade.php ENDPATH**/ ?>