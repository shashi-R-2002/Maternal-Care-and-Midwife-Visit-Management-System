...
<?php $__env->startSection('title','Mother List'); ?>
...
<a href="<?php echo e(route('mothers.index')); ?>" class="active">
...
<div class="main">
    ...
    <div class="content">
        ...
        <div class="stat-cards">
            <div class="stat-card">
                ...
                <div>
    <div class="stat-val" id="totalCount"><?php echo e($totalMothers); ?></div>
    <div class="stat-lbl">Total Mothers</div>
            ...
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-val"><?php echo e($pregnantCount); ?></div>
            ...
            <div class="stat-card">
                ...
                <div>
                    <div class="stat-val"><?php echo e($deliveredCount); ?></div>
    ...
    <h6>All Mothers</h6>
             <p>
                 Showing
               <span id="showCount"><?php echo e($totalMothers); ?></span>
                registered mothers
             </p>
            </div>
                <div class="table-header-right">
                    ...
                    <a href="<?php echo e(route('mothers.create')); ?>" class="btn-add">
...
<tr
    data-name="<?php echo e($mother->full_name); ?>"
    data-reg="<?php echo e($mother->registration_no); ?>"
    data-status="<?php echo e($mother->status); ?>"
>
    ...
    <td>
        <div class="name-cell">
            ...
            <div class="name-avatar">
                <?php echo e(strtoupper(substr($mother->full_name,0,1))); ?>
            ...
            <div>
                ...
                <div class="name-sub">
                    G<?php echo e($mother->gravida); ?>

                    P<?php echo e($mother->para); ?>
    ...
    <td>
        ...
        <div class="action-btns">
            ...
            <a href="<?php echo e(route('mothers.show', $mother->id)); ?>" class="btn-view">
...
<?php endif; ?>
            ...
            <div class="table-footer">
                <span id="footerCount">
                Showing <?php echo e($totalMothers); ?> of <?php echo e($totalMothers); ?> mothers
                       </span>
                <div class="page-btns">
...
<?php echo $__env->make('layouts.midwife', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\maternal-care-system\resources\views/midwife/mother.blade.php ENDPATH**/ ?>