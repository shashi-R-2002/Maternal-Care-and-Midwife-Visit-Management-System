  ...
  <div class="container">
    <div class="about-grid">
      ...
      <div class="about-visual fade-in">
        <div class="about-img-wrap"><img src="<?php echo e(asset('images/about.jpg')); ?>" alt="Maternal Care"></div>
...
<section id="gallery" class="gallery-section">
  <div class="container">
    ...
    <div class="gallery-grid">
      <div class="gallery-item fade-in"><img src="<?php echo e(asset('images/image4.jfif')); ?>"><div class="gallery-overlay"><h4 data-i18n="gal1_title">Prenatal Care</h4><p data-i18n="gal1_sub">Safe and professional healthcare services.</p></div></div>
      <div class="gallery-item fade-in"><img src="<?php echo e(asset('images/image2.jfif')); ?>"><div class="gallery-overlay"><h4 data-i18n="gal2_title">Clinic Visits</h4><p data-i18n="gal2_sub">Organized appointment and clinic management.</p></div></div>
      <div class="gallery-item fade-in"><img src="<?php echo e(asset('images/set3.jpg')); ?>"><div class="gallery-overlay"><h4 data-i18n="gal3_title">Mother Support</h4><p data-i18n="gal3_sub">Helping mothers throughout pregnancy care.</p></div></div>
      <div class="gallery-item fade-in"><img src="<?php echo e(asset('images/image1.jfif')); ?>"><div class="gallery-overlay"><h4 data-i18n="gal4_title">Healthcare Staff</h4><p data-i18n="gal4_sub">Experienced medical and midwife professionals.</p></div></div>
      <div class="gallery-item fade-in"><img src="<?php echo e(asset('images/new3.jfif')); ?>"><div class="gallery-overlay"><h4 data-i18n="gal5_title">Digital Records</h4><p data-i18n="gal5_sub">Modern digital healthcare management system.</p></div></div>
      <div class="gallery-item fade-in"><img src="<?php echo e(asset('images/image3.jfif')); ?>"><div class="gallery-overlay"><h4 data-i18n="gal6_title">Happy Mothers</h4><p data-i18n="gal6_sub">Improving maternal healthcare experiences.</p></div></div>
    </div>
  </div>
</section>
...
<div class="modal fade" id="registerModal" tabindex="-1">
  <div class="modal-dialog modal-dialog-centered auth-dialog">
    <div class="modal-content auth-modal">
      ...
      <div class="auth-body">
       <form method="POST" action="<?php echo e(route('midwife.register')); ?>">
    <?php echo csrf_field(); ?>
    <!-- Full Name -->
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\maternal-care-system\resources\views/home.blade.php ENDPATH**/ ?>