...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('midwife.medicines')); ?>"class="active">
...
<div class="box mb-4">
    ...
    <div class="box-body">
        ...
        <form method="GET" action="<?php echo e(route('midwife.medicines')); ?>">
...
<div class="mother-banner">
    ...
    <div class="banner-left">
        ...
        <div class="banner-avatar">
            ...
            <?php echo e(strtoupper(substr($selectedMother->full_name,0,2))); ?>
    ...
    <div class="banner-pills">
        ...
        <span class="banner-pill edd">
            ...
            EDD :
            <?php echo e(\Carbon\Carbon::parse($selectedMother->edd)->format('d M Y')); ?>
...
<div class="box">
        ...
        <table>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $medicines; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $medicine): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                    ...
                    <td><?php echo e($medicine->remarks); ?></td>

                    <td>

                        <div class="action-btns">

                            <form action="<?php echo e(route('medicines.destroy',$medicine->id)); ?>"
                                  method="POST"
    ...
    <div class="table-footer">
        ...
        <span>
            ...
            <strong><?php echo e($medicines->count()); ?></strong>
...
<?php echo $__env->make('layouts.midwife', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\maternal-care-system\resources\views/midwife/medicines.blade.php ENDPATH**/ ?>