...
<?php $__env->startSection('title','Visit Management'); ?>
...
<div class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('midwife.visits')); ?>"class="active">
...
<div class="main">
    ...
    <div class="box-body">
        ...
        <form method="GET" action="<?php echo e(route('midwife.visits')); ?>">
    ...
    <select name="mother"
        ...
        <?php $__currentLoopData = $mothers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mother): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <option value="<?php echo e($mother->id); ?>"
                <?php echo e(optional($selectedMother)->id == $mother->id ? 'selected' : ''); ?>>

                <?php echo e($mother->registration_no); ?> - <?php echo e($mother->full_name); ?>
...
<?php else: ?>
        ...
        <div class="mother-banner">
            ...
            <div class="banner-left">
                ...
                <div class="banner-avatar">
                    <?php echo e($selectedMother ? strtoupper(substr($selectedMother->full_name,0,2)) : '--'); ?>
                ...
                <div>
                    ...
                    <p class="banner-name">
                        <?php echo e($selectedMother->full_name); ?>
                    ...
                    <div class="banner-meta">
                        ...
                        <span>
                            ...
                            <?php echo e($selectedMother->registration_no); ?>

                        </span>

                        <span>
                            <i class="bi bi-telephone-fill"></i>
                            <?php echo e($selectedMother->phone); ?>

                        </span>

                        <span>
                            <i class="bi bi-droplet-fill"></i>
                            <?php echo e($selectedMother->blood_group); ?>

                        </span>

                        <span>
                            <i class="bi bi-clipboard2-pulse-fill"></i>
                            G<?php echo e($selectedMother->gravida); ?>

                            P<?php echo e($selectedMother->para); ?>
            ...
            <div class="banner-pills">
                ...
                <?php if($selectedMother->status == 'Pregnant'): ?>
                ...
                <span class="banner-pill edd">
                    ...
                    EDD : <?php echo e(\Carbon\Carbon::parse($selectedMother->edd)->format('d M Y')); ?>
    ...
    <form action="<?php echo e(route('visits.store')); ?>" method="POST">
        ...
        <input type="hidden"
       name="mother_id"
       value="<?php echo e($selectedMother->id); ?>">
...
<option value="Clinic Visit"
    <?php echo e(old('visit_type')=='Clinic Visit' ? 'selected' : ''); ?>>
    Clinic Visit
</option>

<option value="Home Visit"
    <?php echo e(old('visit_type')=='Home Visit' ? 'selected' : ''); ?>>
    Home Visit
</option>
            ...
            <div class="col-md-6">
                ...
                <input
                    ...
                    class="field-input"
                    value="<?php echo e(old('next_visit_date')); ?>">
            </div>
            ...
            <div class="col-12">
                ...
                <textarea
                    ...
                    class="field-input"
                    rows="4"
                    placeholder="Record clinical observations, advice given, medications prescribed..."><?php echo e(old('notes')); ?></textarea>
            </div>
...
<div class="box">
        ...
        <table>
            ...
            <?php $__empty_1 = true; $__currentLoopData = $visits; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $visit): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                ...
                <tr>
                    ...
                    <td>
                        <span class="visit-no">
                            V<?php echo e(str_pad($visit->id,3,'0',STR_PAD_LEFT)); ?>
                    ...
                    <td>
                        ...
                        <?php if($visit->next_visit_date): ?>
                            ...
                            <span class="next-date">
                                ...
                                <?php echo e(\Carbon\Carbon::parse($visit->next_visit_date)->format('d M Y')); ?>
                    ...
                    <td>
                        ...
                        <div class="action-btns">
                            ...
                            <a href="<?php echo e(route('visits.edit', $visit->id)); ?>" class="btn-tbl edit">
    ...
    <div class="table-footer">
        ...
        <span>
            ...
            <strong><?php echo e($selectedMother->full_name); ?></strong>
        ...
        <?php if($visits->count() > 0): ?>
            ...
            <span style="color:#16a34a;font-weight:600;font-size:12px;">
                ...
                <?php echo e(optional($visits->first())->next_visit_date
...
<?php endif; ?>
<?php echo $__env->make('layouts.midwife', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\maternal-care-system\resources\views/midwife/visits.blade.php ENDPATH**/ ?>